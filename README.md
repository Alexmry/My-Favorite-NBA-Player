...
2. Navigation (UX) on Algolia's website can be a bit confusing for 1st time users. The "Widgets Showcase" page is great but it took me a while to come cross it and to switch it from React to JavaScript.
